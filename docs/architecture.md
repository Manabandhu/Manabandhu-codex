...
- **Data**: PostgreSQL for relational data, Redis for cache/session, Meilisearch for search, Kafka for async events.
- **Infra**: Docker Compose for local orchestration, GitHub Actions for CI, Fly.io/Render ready Docker images, Vercel for web, Expo EAS for OTA/mobile.
