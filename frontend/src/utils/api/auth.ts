...
import { LoginRequest, LoginResponse, SignupRequest, OnboardingRequest, User } from '@/types';
...
export const authApi = {
  ...
  completeOnboarding: (payload: Partial<OnboardingRequest>) => api.post<void>('/auth/onboarding', payload).then((r) => r.data),
